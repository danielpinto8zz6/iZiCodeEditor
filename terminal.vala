class Terminal : Object, iZiCodeEditor.Extension {
    ...
    public iZiCodeEditor.Plugins plugins { get ; construct set ; }
    ...
    void activate() {
        ...
        terminal.child_exited.connect (() => {
            plugins.bottomBar.remove_page (plugins.bottomBar.page_num (scrolled)) ;
        }) ;

        Gtk.Label labelTerminal = new Gtk.Label ("Terminal") ;

        plugins.bottomBar.append_page (gridTerminal, labelTerminal) ;
    }
...
public void peas_register_types(TypeModule module) {
    ...
    objmodule.register_extension_type (typeof (iZiCodeEditor.Extension), typeof
                                       (Terminal)) ;
}
